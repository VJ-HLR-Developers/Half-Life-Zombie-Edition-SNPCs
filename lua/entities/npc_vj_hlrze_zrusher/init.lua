...
ENT.LeapAttackMaxDistance = 2000
ENT.LeapAttackDamageDistance = 100
ENT.LeapAttackAngleRadius = 60
ENT.TimeUntilLeapAttackDamage = 1
ENT.TimeUntilLeapAttackVelocity = 0
ENT.NextLeapAttackTime = 1.5
ENT.NextAnyAttackTime_Leap = false

-- !!!! Following should be removed in favor of calling it in the leap function !!!! - DrVrej
